...
points_loop_cond:
	...
	la	$t4, my_points
	mul	$t5, $t0, POINT2D_SZ	# i * sizeof(element)
	add	$t4, $t4, $t5		# &my_points[i] = $t4

	lw	$t1, POINT2D_ROW_OFFSET($t4)	# $t1 = row
	lw      $t2, POINT2D_COL_OFFSET($t4)    # $t2 = col

	mul	$t4, $t1, MAP_SIZE		# row * N_COLS
	add	$t4, $t4, $t2			# + col
